    ...
    >
      ...
      >
        ...
        >
          ...
          <Link
            ...
            className={
              isResearch
                ...
                : "inline-flex h-11 cursor-pointer items-center justify-center rounded-xl border border-emerald-200 bg-emerald-50 px-5 text-sm font-bold text-emerald-700 shadow-sm transition hover:-translate-y-0.5 hover:border-emerald-300 hover:bg-emerald-100 hover:shadow-md dark:border-emerald-800/70 dark:bg-emerald-950/40 dark:text-emerald-200 dark:hover:bg-emerald-900/55"
            }
          >
            Go to login
          </Link>
          {isResearch && (
            <p>
              <Link href="/login" className={researchAuthLinkClass}>
                Back to sign in
              </Link>
            </p>
          )}
