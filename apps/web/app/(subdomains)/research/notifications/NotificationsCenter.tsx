        ...
        <div className="flex min-w-0 flex-1 items-center justify-between gap-4">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              <h1 className="truncate text-sm font-normal uppercase tracking-wide text-[#E4E4E4]">
                Notification Center
              </h1>
          ...
          <button
            ...
            className="inline-flex h-10 flex-none cursor-pointer items-center justify-center gap-2 border border-[#A8DADC] bg-[#263636] px-4 text-sm font-normal text-[#A8DADC] shadow-none transition duration-150 ease-out hover:-translate-y-0.5 hover:bg-[#303F3F] disabled:cursor-not-allowed disabled:border-[#444444] disabled:bg-transparent disabled:text-[#666666] disabled:hover:translate-y-0"
          >
