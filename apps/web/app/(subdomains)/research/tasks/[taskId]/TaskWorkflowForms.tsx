    ...
    <>
      ...
      >
        ...
        >
          ...
          {helperText ? (
            <p className="research-task-workflow-note rounded-none border border-amber-200 bg-amber-50 px-3 py-2 text-xs leading-5 text-amber-800 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-100">
              {helperText}
            </p>
          ) : null}
        </form>
