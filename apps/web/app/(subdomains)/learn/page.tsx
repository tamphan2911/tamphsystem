          ...
          <div className="pt-16 lg:pt-24">
            ...
            <div className="mt-10 max-w-2xl">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                {["AI", "Data", "Python", "Research", "Finance", "Writing"].map(
                  (item) => (
                    <Link
                      key={item}
                      href={`/courses?q=${encodeURIComponent(item)}`}
                      className="rounded-lg border border-[#5a4050] bg-[#17111f]/60 px-5 py-2 text-lg text-[#d9d4df] hover:border-[#ff8a3d] hover:text-white"
                    >
                      {item}
                    </Link>
                  ),
