...
export const researchFieldClass =
  "h-12 w-full rounded-none border border-[#444444] bg-[#121212] px-3 text-sm font-normal text-[#E0E0E0] outline-none transition duration-150 ease-out placeholder:text-[#888888] hover:border-[#888888] hover:bg-[#181818] focus:border-[#888888] focus:bg-[#181818] focus:ring-2 focus:ring-[#888888]/25 disabled:cursor-not-allowed disabled:bg-[#181818] disabled:text-[#888888]";

export const researchTextareaClass =
  "min-h-28 w-full rounded-none border border-[#444444] bg-[#121212] px-3 py-2.5 text-sm font-normal text-[#E0E0E0] outline-none transition duration-150 ease-out placeholder:text-[#888888] hover:border-[#888888] hover:bg-[#181818] focus:border-[#888888] focus:bg-[#181818] focus:ring-2 focus:ring-[#888888]/25 disabled:cursor-not-allowed disabled:bg-[#181818] disabled:text-[#888888]";

export const researchLabelClass =
  "grid gap-1.5 text-sm font-normal text-[#E0E0E0]";

export const researchSectionClass =
  "rounded-none border border-[#444444] bg-[#121212] p-5";

export const researchItemClass =
  "rounded-none border border-[#444444] bg-[#121212]";

const buttonClasses: Record<ButtonTone, string> = {
  primary:
    "border-[#888888] bg-[#E0E0E0] text-[#121212] hover:border-[#E0E0E0] hover:bg-white hover:text-[#121212] focus:ring-[#888888]/25",
  secondary:
    "border-[#444444] bg-[#121212] text-[#E0E0E0] hover:border-[#888888] hover:bg-[#242424] hover:text-white focus:ring-[#888888]/20",
  danger:
  ...
  quiet:
    "border-transparent bg-transparent text-[#B0B0B0] shadow-transparent hover:border-[#444444] hover:bg-[#242424] hover:text-[#E0E0E0] focus:ring-[#888888]/20",
};
...
const iconToneClasses: Record<Tone, string> = {
  ...
  slate:
    "border-[#444444] bg-[#121212] text-[#B0B0B0] hover:border-[#888888] hover:bg-[#242424] hover:text-[#E0E0E0]",
  ...
  return (
    <IconHint label={label}>
      <button
        ...
        className={cx(
          "inline-flex h-9 w-9 cursor-pointer items-center justify-center rounded-none border shadow-sm outline-none transition duration-150 ease-out hover:shadow-md focus:ring-2 focus:ring-[#888888]/20 active:translate-y-0 disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:shadow-sm motion-reduce:transition-none",
...
export function IconHint({
  ...
  return (
    <span className="group/icon relative inline-flex">
      ...
      <span
        className={cx(
          "pointer-events-none absolute left-1/2 z-50 -translate-x-1/2 whitespace-nowrap rounded-none border border-[#444444] bg-[#121212] px-2.5 py-1.5 text-[11px] font-normal text-[#E0E0E0] opacity-0 shadow-lg shadow-black/30 transition duration-200 ease-out group-hover/icon:translate-y-0 group-hover/icon:opacity-100",
          position === "top"
